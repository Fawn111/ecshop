...
const AddProductModal = ({ onClose }) => {
   ...
   const [brand, setBrand] = useState({
      ...
      e.preventDefault();
      try {
        const res = await fetch('http://localhost:3000/api/brands/add', {
          method: 'POST',
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/10 backdrop-blur-sm z-50">
      <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl relative animate-fade-in">
        <h3 className="text-2xl font-bold mb-6 text-center text-gray-800">Add Brand</h3>
  ...
  return (
    <div className="relative p-6 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-semibold text-gray-800">Brands</h2>
        <button
