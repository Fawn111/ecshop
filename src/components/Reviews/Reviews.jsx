...
const PrevArrow = (props) => (
  <div {...props} className="slick-prev absolute left-[-15px] top-1/2 z-10 cursor-pointer">
    <FaArrowLeft className="text-white" />
  </div>
);

const NextArrow = (props) => (
  <div {...props} className="slick-next absolute right-[-15px] top-1/2 z-10 cursor-pointer">
